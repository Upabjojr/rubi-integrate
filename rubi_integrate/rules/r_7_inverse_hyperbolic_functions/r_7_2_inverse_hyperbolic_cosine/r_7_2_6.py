...
from sympy import (
    Chi, Shi, acosh,
    asech, cosh, erf, erfi, exp, pi, sinh, sqrt, tanh,
)
...
RULES = [
    ...
    SymPyReplacementPattern(
        ...
        replacement=With({w: IntHide(v_, x)}, -_b_*Int(SimplifyIntegrand(w*D(u_, x)/(sqrt(u_ - 1)*sqrt(u_ + 1)), x), x) + Dist(_a_ + _b_*acosh(u_), w, x)),
        module_name='7.2.6 Miscellaneous inverse hyperbolic cosine',
        rule_number=24,
    ),
    # Rule 25
